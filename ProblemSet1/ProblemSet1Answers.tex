...
\noindent Express the derivative dS/dx, denoted as S', of the following activation functions S in terms of the \\ original function S, i.e., determine f such that S' = f(S,x). 
...
maximize the truth value of not(A(x) OR B(x)) we should minimize the truth value of A(x) OR B(x). 
