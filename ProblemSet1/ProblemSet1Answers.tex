...
\begin{enumerate} [label=\Alph*]
  ...
  \begin{center} \includegraphics[width=0.5\textwidth]{Problem3_a2.png} \end{center}

  \newpage
  \item Here are some of the tests:
  \begin{center} \includegraphics[width=0.5\textwidth]{Problem3_B_1.png} \end{center}
  \begin{center} \includegraphics[width=0.5\textwidth]{Problem3_B_2.png} \end{center}
  \begin{center} \includegraphics[width=0.5\textwidth]{Problem3_B_3.png} \end{center}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=0.4\textwidth]{Problem5_logsig_all.png}
  \caption{This is the caption of the image.}
\end{figure}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=0.4\textwidth]{Problem5_Swish_all.png}
  \caption{This is the caption of the image.}
\end{figure}
...
\begin{enumerate}[label=\Alph*]
  ...
  \begin{center} \includegraphics[width=0.9\textwidth]{Problem7_relu.png} \end{center}
  \item ELU: ?
  \end{enumerate}
