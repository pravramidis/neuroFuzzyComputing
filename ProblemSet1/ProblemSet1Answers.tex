...
\begin{enumerate}[label=\Alph*]
  ...
  \begin{center} \includegraphics[width=0.8\textwidth]{Problem7_swish.png} \end{center} \newpage
  \item sigmoid: L = 5, k = 2.5, m = 0
  \begin{center} \includegraphics[width=0.8\textwidth]{Problem7_sigmoid.png} \end{center}
  \item ReLU: L = 0, k = 1, m is not relevant. \\ As we can see the apporoximation is so good the Relu function is not visible.
  \begin{center} \includegraphics[width=0.8\textwidth]{Problem7_relu.png} \end{center}
  \newpage
  \item ELU: L = 50, k = 1, m = 6.5
  \begin{center} \includegraphics[width=0.8\textwidth]{Problem7_elu.png} \end{center}
  \end{enumerate}
...
\begin{enumerate}[label=\Alph*]
  ...
  ${a < \frac{1}{\lambda_i}}$ or ${0 < a < \frac{1}{\lambda_i}}$. Therefore we get the maximum stable learning rate when ${a = \frac{1}{\lambda_{max}}}$. 
  \\ \\ $R = \begin{bmatrix}
    12.4 & 7.6 \\
    7.6 & 6.4
  \end{bmatrix} $
...
learning rate we should choose the maximum lambda. So,
\\ \\ ${a = \frac{1}{\lambda_{max}} \Rightarrow a= \frac{1}{\frac{47 + \sqrt{1669} }{5}}} \Rightarrow a = \frac{5}{47+\sqrt{1669}} \Rightarrow a \approx 0.0569 $\\ \\
...
\begin{enumerate} [label=\Alph*]
  \item \leavevmode \begin{center} \includegraphics[width=0.8\textwidth]{Problem9_A.png} \end{center}
  \newpage
